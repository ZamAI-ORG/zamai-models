#!/usr/bin/env python3
"""
Training script for ZamAI-Pashto-Chat-8B
...
def train_zamai_pashto_chat_8b():
    """Train ZamAI-Pashto-Chat-8B model"""
    
    print("🚀 Starting ZamAI-Pashto-Chat-8B training...")
    
    # Model configuration
    model_name = "meta-llama/Llama-3.1-8B-Instruct"
    output_dir = "./outputs/zamai-pashto-chat-8b"
